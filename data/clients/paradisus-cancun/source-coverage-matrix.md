...
| YouTube videos + comments | ✅ captured | yes | yes | yes | 40 | 40 | unknown | yes | high | Captured. No per-outlet YouTube review listing; outlet mentions appear within the property-level YouTube capture (videos + comments), not as a separate outlet listing. |
| Reddit / forums | ✅ captured | yes | yes | yes | 28 | 28 | unknown | yes | high | Captured. No per-outlet Reddit/forum listing; outlet mentions appear within the property-level Reddit/forum capture, not as a separate outlet listing. |
