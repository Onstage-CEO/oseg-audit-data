...
_Generated 2026-07-19 · matrix V2 · capability V2 · attempts V1._
...
- The Scott Resort & Spa: Yelp reviews is not checked; Not checked — no explicit source attempt is recorded for this workspace. The engine supports this source, but this workspace contains no explicit attempt record.
- The Scott Resort & Spa: Expedia reviews is provider error; The source attempt failed at the provider/adapter layer. Apify expedia: actor run ended ABORTED.
...
- The Scott Resort & Spa: TikTok mentions is not checked; Not checked — no explicit source attempt is recorded for this workspace. The engine supports this source, but this workspace contains no explicit attempt record.
...
_6/11 engine-supported sources captured_
...
| Yelp reviews | ⬜ not checked | not_checked | unknown | no | yes | no | ? | 0 | yes | low | Not checked — no explicit source attempt is recorded for this workspace. The engine supports this source, but this workspace contains no explicit attempt record. |
...
| Expedia reviews | ❌ provider error | provider_error | unknown | no | yes | no | ? | 0 | yes | low | The source attempt failed at the provider/adapter layer. Apify expedia: actor run ended ABORTED. |
...
| TikTok mentions | ⬜ not checked | not_checked | unknown | no | yes | no | ? | 0 | yes | low | Not checked — no explicit source attempt is recorded for this workspace. The engine supports this source, but this workspace contains no explicit attempt record. |
