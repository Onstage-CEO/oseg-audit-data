# Browser-capture task — The Phoenician Resort and Spa

> **Generated handoff package — do not edit by hand.** Regenerate with
> `oseg-audit browser-capture-pack the-phoenician-resort-and-spa-rebuilt-2026-07-31`. This is the bridge that
...
You are capturing live guest-review evidence for **The Phoenician Resort and Spa** (Scottsdale, Arizona, Marriott Luxury Collection) using Joe's logged-in browser. Work the **required**
...
| Field | Value |
|---|---|
| Slug | `the-phoenician-resort-and-spa-rebuilt-2026-07-31` |
...
- **Run these searches:**
  - `The Phoenician Resort and Spa Scottsdale, Arizona reviews`
  - `The Phoenician Resort and Spa entertainment`
  - `The Phoenician Resort and Spa nightlife`
  - `The Phoenician Resort and Spa live music`
  - `The Phoenician Resort and Spa after dinner`
  - `The Phoenician Resort and Spa evening`
  - `The Phoenician Resort and Spa family`
  - `The Phoenician Resort and Spa atmosphere`
...
- **Run these searches:**
  - `site:reddit.com The Phoenician Resort and Spa review`
  - `site:reddit.com The Phoenician Resort and Spa nightlife`
  - `site:reddit.com The Phoenician Resort and Spa entertainment`
  - `site:reddit.com The Phoenician Resort and Spa party`
  - `site:reddit.com The Phoenician Resort and Spa Scottsdale, Arizona`
...
- **Run these searches:**
  - `The Phoenician Resort and Spa walkthrough`
  - `The Phoenician Resort and Spa resort tour`
  - `The Phoenician Resort and Spa vlog`
  - `The Phoenician Resort and Spa Scottsdale, Arizona tour`
...
- **Run these searches:**
  - `"The Phoenician Resort and Spa" review blog`
  - `"The Phoenician Resort and Spa" noise`
  - `"The Phoenician Resort and Spa" honest review`
...
1. **capture-record** — Record provenance for each artifact you captured (one per source page). Offline — only hashes the local screenshot.
   ```bash
   oseg-audit capture-record --source-url "<live url>" --platform <platform> --property "<name>" --location "<location>" --local-path <screenshot> --reviewer "<you>" -o data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/captures.json
   ```
2. **research-intake** — Turn your authored findings (verbatim quotes + themes, tied to the captured URLs) into an evidence patch.
   ```bash
   oseg-audit research-intake data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/findings.json --id-prefix <slugPrefix> -o data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/evidence-patch.json
   ```
3. **merge-evidence** — Merge the new evidence into the audit.
   ```bash
   oseg-audit merge-evidence data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/audit.json data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/evidence-patch.json
   ```
4. **capture-coverage** — See which planned sources / theme slots / keywords still have no evidence — loop back to step 1 for the gaps.
   ```bash
   oseg-audit capture-coverage data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/audit.json --plan data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/research-plan.json --capture-archive data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/captures.json
   ```
5. **promote-live-verified** — For each record you personally confirmed on the live page, promote it to live_verified (records HOW it was confirmed).
   ```bash
   oseg-audit promote-live-verified data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/audit.json --evidence-id <id>
   ```
6. **verify** — The gate. Exit 0 = READY (teaser/deck unlock); nonzero = NOT READY — run `oseg-audit doctor the-phoenician-resort-and-spa-rebuilt-2026-07-31` for the single next action.
   ```bash
   oseg-audit verify data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/audit.json --capture-archive data/clients/the-phoenician-resort-and-spa-rebuilt-2026-07-31/captures.json --summary
   ```
