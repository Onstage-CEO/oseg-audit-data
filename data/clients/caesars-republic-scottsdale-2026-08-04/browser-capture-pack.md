# Browser-capture task — Caesars Republic Scottsdale, a Hilton Hotel

> **Generated handoff package — do not edit by hand.** Regenerate with
> `oseg-audit browser-capture-pack caesars-republic-scottsdale-2026-08-04`. This is the bridge that
...
You are capturing live guest-review evidence for **Caesars Republic Scottsdale, a Hilton Hotel** (Scottsdale, Arizona, Caesars Republic / Hilton) using Joe's logged-in browser. Work the **required**
...
| Field | Value |
|---|---|
| Slug | `caesars-republic-scottsdale-2026-08-04` |
| Property | Caesars Republic Scottsdale, a Hilton Hotel |
| Location | Scottsdale, Arizona |
| Brand | Caesars Republic / Hilton |
...
- **Run these searches:**
  - `Caesars Republic Scottsdale, a Hilton Hotel Scottsdale, Arizona reviews`
  ...
  - `Caesars Republic Scottsdale, a Hilton Hotel after dinner`
  - `Caesars Republic Scottsdale, a Hilton Hotel evening`
  - `Caesars Republic Scottsdale, a Hilton Hotel family`
  - `Caesars Republic Scottsdale, a Hilton Hotel atmosphere`
...
- **Run these searches:**
  - `site:reddit.com Caesars Republic Scottsdale, a Hilton Hotel review`
  ...
  - `site:reddit.com Caesars Republic Scottsdale, a Hilton Hotel party`
  - `site:reddit.com Caesars Republic Scottsdale, a Hilton Hotel Scottsdale, Arizona`
...
- **Run these searches:**
  - `Caesars Republic Scottsdale, a Hilton Hotel walkthrough`
  - `Caesars Republic Scottsdale, a Hilton Hotel resort tour`
  - `Caesars Republic Scottsdale, a Hilton Hotel vlog`
  - `Caesars Republic Scottsdale, a Hilton Hotel Scottsdale, Arizona tour`
...
- **Run these searches:**
  - `"Caesars Republic Scottsdale, a Hilton Hotel" review blog`
  - `"Caesars Republic Scottsdale, a Hilton Hotel" noise`
  - `"Caesars Republic Scottsdale, a Hilton Hotel" honest review`
...
1. **capture-record** — Record provenance for each artifact you captured (one per source page). Offline — only hashes the local screenshot.
   ```bash
   oseg-audit capture-record --source-url "<live url>" --platform <platform> --property "<name>" --location "<location>" --local-path <screenshot> --reviewer "<you>" -o data/clients/caesars-republic-scottsdale-2026-08-04/captures.json
   ```
2. **research-intake** — Turn your authored findings (verbatim quotes + themes, tied to the captured URLs) into an evidence patch.
   ```bash
   oseg-audit research-intake data/clients/caesars-republic-scottsdale-2026-08-04/findings.json --id-prefix <slugPrefix> -o data/clients/caesars-republic-scottsdale-2026-08-04/evidence-patch.json
   ```
3. **merge-evidence** — Merge the new evidence into the audit.
   ```bash
   oseg-audit merge-evidence data/clients/caesars-republic-scottsdale-2026-08-04/audit.json data/clients/caesars-republic-scottsdale-2026-08-04/evidence-patch.json
   ```
4. **capture-coverage** — See which planned sources / theme slots / keywords still have no evidence — loop back to step 1 for the gaps.
   ```bash
   oseg-audit capture-coverage data/clients/caesars-republic-scottsdale-2026-08-04/audit.json --plan data/clients/caesars-republic-scottsdale-2026-08-04/research-plan.json --capture-archive data/clients/caesars-republic-scottsdale-2026-08-04/captures.json
   ```
5. **promote-live-verified** — For each record you personally confirmed on the live page, promote it to live_verified (records HOW it was confirmed).
   ```bash
   oseg-audit promote-live-verified data/clients/caesars-republic-scottsdale-2026-08-04/audit.json --evidence-id <id>
   ```
6. **verify** — The gate. Exit 0 = READY (teaser/deck unlock); nonzero = NOT READY — run `oseg-audit doctor caesars-republic-scottsdale-2026-08-04` for the single next action.
   ```bash
   oseg-audit verify data/clients/caesars-republic-scottsdale-2026-08-04/audit.json --capture-archive data/clients/caesars-republic-scottsdale-2026-08-04/captures.json --summary
   ```
